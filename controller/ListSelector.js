sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("com.eric.ZManageNotiApp1.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias aa4.aa4.controller.ListSelector
			 */
			 ...
			 * @return {aa4.aa4.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
			...
			deleteMasterListSelection : function (oItem) {
				//use promise to make sure that 'this._oList' is available
				this._oWhenListHasBeenSet.then(function () {
					this._oList.removeItem(oItem);
				}.bind(this));
			}
